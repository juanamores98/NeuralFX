...
- El mod se ensaya con dobles Unity: layouts, migración, mil frames sin consumidor, restauración personalizada y conflicto de escritura, epochs y permiso de jitter. No certifica APIs del ensamblado propietario de CS1.
